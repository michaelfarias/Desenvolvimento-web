package br.ufc.crateus.web.application7.view.bean;

import java.util.List;

import javax.faces.bean.ManagedBean;

import br.ufc.crateus.web.application7.model.Disciplina;
import br.ufc.crateus.web.application7.repository.DisciplinaRepository;
